...
# Level 11
s = set()
s.update([''.join(p) for p in permutations('dddddddddd')])
s.update([''.join(p) for p in permutations('ddddddddda')])
s.update([''.join(p) for p in permutations('ddddddddaa')])
s.update([''.join(p) for p in permutations('dddddddaaa')])
s.update([''.join(p) for p in permutations('ddddddaaaa')])
s.update([''.join(p) for p in permutations('dddddaaaaa')])
s.update([''.join(p) for p in permutations('ddddaaaaaa')])
s.update([''.join(p) for p in permutations('dddaaaaaaa')])
s.update([''.join(p) for p in permutations('ddaaaaaaaa')])
s.update([''.join(p) for p in permutations('daaaaaaaaa')])
s.update([''.join(p) for p in permutations('aaaaaaaaaa')])
levels.append(getSequenceArray(s))

# Level 12+
s = set()
s.update([''.join(p) for p in permutations('ddddddddddd')])
s.update([''.join(p) for p in permutations('dddddddddda')])
s.update([''.join(p) for p in permutations('dddddddddaa')])
s.update([''.join(p) for p in permutations('ddddddddaaa')])
s.update([''.join(p) for p in permutations('dddddddaaaa')])
s.update([''.join(p) for p in permutations('ddddddaaaaa')])
s.update([''.join(p) for p in permutations('dddddaaaaaa')])
s.update([''.join(p) for p in permutations('ddddaaaaaaa')])
s.update([''.join(p) for p in permutations('dddaaaaaaaa')])
s.update([''.join(p) for p in permutations('ddaaaaaaaaa')])
s.update([''.join(p) for p in permutations('daaaaaaaaaa')])
s.update([''.join(p) for p in permutations('aaaaaaaaaaa')])
levels.append(getSequenceArray(s))
